...
public class ActionEntityDemo implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		ActionEntity action1 = this.factory.createNewAction("123", "columnToDoList","AddMission",
				new Date(),"tomboukai@gmail.com","tomboukai",details);

		
		System.err.println("\n"+"Data before storing: " + action1.getActionType() + ", " + action1.getPlayerEmail()+", "+action1.getElementId()); //ADD toString to see all data
		
		action1 = this.dao.create(action1);
		System.err.println("Data after storing: " + action1.getActionType() + ", " + action1.getPlayerEmail()+", "+action1.getElementId()); //ADD toString to see all data
